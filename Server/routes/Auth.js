...
const { Transport, storage } = require("../config/lib")
const { db } = require("../config/db")

router.post("/signup", multer({ storage }).single("image"), async (req, res) => {
    try {
...
router.put("/update_profile", multer({ storage }).single("image"), async (req, res) => {
    try {
