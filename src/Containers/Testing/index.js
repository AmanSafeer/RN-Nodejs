 ...
 */
 ...
 const Testing = () => {
   ...
   const sendMessage = () => {
     if (name && message) {
       Axios.post(
         `${Variables.baseUrl}/send_messages`,
         { name, message },
   ...
   const getMessages = () => {
     Axios.get(`${Variables.baseUrl}/get_messages`)
       .then(res => {
   ...
   const getFilteredMessages = () => {
     Axios.get(`${Variables.baseUrl}/get_filtered_messages`, { params: { name: "Aman" } })
       .then(res => {
         console.log("get response", res)
         setMessages(res.data)
       })
   ...
   const updateMessage = () => {
     ...
     Axios.put(
       `${Variables.baseUrl}/update_messages`,
       payload,
       { headers: { 'Content-Type': 'application/json' } }
     )
       .then(res => {
   ...
   const updateMultiMessage = () => {
     ...
     Axios.put(
       `${Variables.baseUrl}/update_multi_messages`,
       payload,
       { headers: { 'Content-Type': 'application/json' } }
     )
       .then(res => {
   ...
   const deleteMessage = (_id) => {
     Axios.delete(
       `${Variables.baseUrl}/delete_messages`,
   ...
   const deleteMultiMessage = () => {
     Axios.delete(
       `${Variables.baseUrl}/delete_multi_messages`,
